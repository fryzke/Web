        ...
        <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
            ...
            <nav id="store" class="w-full z-30 top-0 px-6 py-1">
                <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-2 py-3">
                    ...
                    <a class="uppercase tracking-wide no-underline hover:no-underline font-bold text-gray-800 text-xl " href="itempage?category=<%=cate%>">
				<%=cate %>
			</a>
              </div>
            </nav>
			<%
				String sql = "SELECT itemid, itemname, price FROM " + cate;
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="itemView.jsp?category=<%= cate%>&itemid=<%= rs.getString(1)%>">
                    <img class="hover:grow hover:shadow-lg" src="https://images.unsplash.com/photo-1555982105-d25af4182e4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&h=400&q=80">
                    <div class="pt-3 flex items-center justify-between">
                        <p class=""><%= rs.getString(2) %></p>
                    ...
                    <p class="pt-1 text-gray-900"><%= rs.getInt(3) %></p>
                </a>
            </div>
			<%
				}
