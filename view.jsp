...
<%
	...
	if(session.getAttribute("id") != null){
		usrID = (String)session.getAttribute("id");
	}
	...
	board_db bd = new board_listing().getLog(logid);
%>
 <nav id="header" class="w-full z-30 top-0 py-1">
	...
	<div id="menu-bar">
		<ul>
			<li><a href="itempage.jsp?category=toy">ITEM1</a></li>
			<li><a href="itempage.jsp?category=snack">ITEM2</a></li>
			<li><a href="itempage.jsp?category=care">ITEM3</a></li>
			<li><a href="itempage.jsp?category=health">ITEM4</a></li>
	...
	<div>
		<section>
				<table class="table">
					<thead class="thead-dark"><tr><th colspan="2">게시글</th></tr></thead>
					<tbody>
						<tr><td>제목</td><td><%= bd.getLog_title() %></td></tr>
						<tr><td>작성자</td><td><%= bd.getWriter() %></td></tr>
						<tr><td>작성일</td><td><%= bd.getLog_date().substring(0, 10) %></td></tr>
						<tr><td>내용</td><td height="600"><%= bd.getLog_content() %></td></tr>
					</tbody>
				</table>
		</section>
	</div>
