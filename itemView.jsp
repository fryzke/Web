...
<%
	...
	i_id = request.getParameter("itemid");
	String link;
	if(id != null){
		if(id.equals("admin")){
			link = "adminpage.jsp";
...
<body class="bg-white text-gray-600 work-sans leading-normal text-base tracking-normal">
	...
	<div id="menu-bar">
	 ...
	 <form method="post" action="/IP_pro/addCart" name="item_form">
    	<table>
	<%
	String sql = "SELECT itemid, itemname, price FROM " +cate+" WHERE itemid = ?";
...
%>
    	<tr><td rowspan="5"><img src="https://images.unsplash.com/photo-1555982105-d25af4182e4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&h=400&q=80"></td></tr>
    	<tr><td>상품코드</td><td><input type="text" name="itemid" value=<%= rs.getString(1) %> readonly/></td></tr>
    	<tr><td>상품명</td><td><%= rs.getString(2) %></td></tr>
    	<tr><td>가격</td><td><input type="text" name="itemprice" value=<%= rs.getInt(3)%> readonly/></td></tr>
...
%>
		<tr>
    	<td>
			구매수량 <input type="number" name="pc" value="1">
